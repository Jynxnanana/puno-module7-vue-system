...
<template>
  ...
  >
    <!-- Top orange line -->
    <div
      class="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-orange-500 via-orange-400 to-transparent"
    ></div>
    ...
    >
      <div class="flex flex-col items-center gap-3">
        <svg
          class="w-20 h-20"
          :class="darkMode ? 'text-gray-700' : 'text-orange-200'"
          fill="none"
          viewBox="0 0 100 100"
        >
          <circle
          ...
          <path
            d="M30 40h40l-4 25a4 4 0 01-4 3.5H38a4 4 0 01-4-3.5L30 40z"
            fill="none"
            stroke="currentColor"
            stroke-width="2.5"
          ...
          <path
            d="M35 40l3-10a5 5 0 015-4h14a5 5 0 015 4l3 10"
            fill="none"
            stroke="currentColor"
            stroke-width="2.5"
    ...
    >
      <div
        ...
        :class="[
          darkMode
            ? 'bg-gray-900/60 hover:bg-orange-500/5'
      ...
      >
        ...
        <div class="flex items-start justify-between gap-3 mb-3">
          ...
          <span
            :class="[
              'inline-flex items-center gap-1.5 border text-xs font-semibold px-2.5 py-1 rounded-full shrink-0',
              statusConfig(record.status).class
            ]"
          >
            <span
              :class="[
        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <button
            @click="emit('view-receipt', record)"
            :class="
              darkMode
        ...
        <div class="flex flex-col gap-2">
          ...
          <!-- ARCHIVE BUTTON -->
          <button
            v-if="record.status === 'Completed' && !record.archived"
            @click="emit('archive', record.id)"
            :class="
              darkMode
                ? 'bg-gray-700/40 text-gray-300 hover:bg-gray-700 border-gray-600/30'
                : 'bg-gray-100 text-gray-600 hover:bg-gray-200 border-gray-200'
            "
            class="btn-shimmer border text-xs font-semibold px-4 py-2 rounded-xl transition-all duration-150 active:scale-95 w-full"
          >
            Archive
          </button>
      ...
      <table class="w-full text-sm">
        ...
        >
          <tr
            ...
            :class="[
              darkMode
                ? 'hover:bg-orange-500/5 text-gray-300'
                : 'hover:bg-orange-50/60 text-gray-700',
          ...
          >
            ...
            <td class="px-6 py-4">
              <div
                class="flex items-center gap-2 opacity-60 group-hover:opacity-100 transition-opacity duration-150"
              >
                ...
                <button
                  ...
                  :class="
                    darkMode
                      ...
                      : 'bg-gray-100 text-gray-600 hover:bg-gray-200 border-gray-200'
                  "
                  class="btn-shimmer border text-xs font-semibold px-3 py-1.5 rounded-lg transition-all duration-150 active:scale-95 whitespace-nowrap"
                >
                  Archive
                </button>
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    "
                  >
                    {{ confirmDeleteRecord.customerName }}
                  </span>
...
**Important:** Your uploaded file already has the Archive functionality in all three required places: `defineEmits`, mobile card, and desktop table.

The next thing you need is the **`App.vue` `archiveRecord()` function and the Active / Archived / All filter**, otherwise clicking **Archive** won't actually move the order to Archived.
